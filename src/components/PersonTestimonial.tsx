...
const PersonTestimonial: React.FC<PersonTestimonialProps> = ({ testimonial, person, personImg, title }) => {
  return (
    <div className="bg-gray-50 rounded-xl p-6 shadow-md flex flex-col justify-between h-full">
      <div>
        <svg
          height={30}
          width={30}
        ...
        <p className="font-semibold text-lg">{testimonial}</p>
      </div>
...
export default PersonTestimonial;
