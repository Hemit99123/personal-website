...
const BlogSection = () => {
  ...
  return (
    <div className="flex flex-col items-center my-20">
        ...
        <button onClick={handleGoBlog} className="bg-black text-white px-10 py-3 rounded-lg hover:bg-white hover:text-black duration-500 border-2 mt-2">Check it out 😪</button>
    </div>  
  )
}
